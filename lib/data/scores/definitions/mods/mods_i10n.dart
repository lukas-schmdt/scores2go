...
class ModsI10n extends ScoreI10n {
  ...
  static const _strings = {
    'en': {
      ...
      'calc.interp.none': 'No dysfunction — MODS 0 (~0% ICU mortality)',
      'calc.interp.mild': 'Mild — MODS 1–4',
      'calc.interp.moderate': 'Moderate — MODS 5–8',
      'calc.interp.severe': 'Severe — MODS 9–12 (~25% ICU mortality)',
      'calc.interp.verySevere': 'Very severe — MODS 13–16 (~50% ICU mortality)',
      'calc.interp.extreme': 'Extreme — MODS 17–20 (~75% ICU mortality)',
      'calc.interp.maximum': 'Maximum dysfunction — MODS 21–24 (~100% ICU mortality)',
    },
    'de': {
      'display': 'MODS',
      'description':
      ...
      'calc.interp.none': 'Keine Dysfunktion — MODS 0 (~0 % ICU-Letalität)',
      'calc.interp.mild': 'Leicht — MODS 1–4',
      'calc.interp.moderate': 'Moderat — MODS 5–8',
      'calc.interp.severe': 'Schwer — MODS 9–12 (~25 % ICU-Letalität)',
      'calc.interp.verySevere': 'Sehr schwer — MODS 13–16 (~50 % ICU-Letalität)',
      'calc.interp.extreme': 'Extrem — MODS 17–20 (~75 % ICU-Letalität)',
      'calc.interp.maximum': 'Maximale Dysfunktion — MODS 21–24 (~100 % ICU-Letalität)',
    },
  };
}
