...
ScoreResult euroscoreFunction(Score score) {
  ...
  final creatHigh   = ctx.boolValue('euroscore-creatinine_high')?['value'] as bool?;
  ...
  final diabInsulin = ctx.boolValue('euroscore-diabetes_insulin')?['value'] as bool?;
  ...
  final thorAorta   = ctx.boolValue('euroscore-thoracic_aorta')?['value'] as bool?;
  final sepRupture  = ctx.boolValue('euroscore-septal_rupture')?['value']  as bool?;

  final allComplete = age != null &&
      female != null &&
      creatHigh != null &&
      arterio != null &&
      poorMob != null &&
