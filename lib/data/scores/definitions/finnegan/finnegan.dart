    ...
    groups: [
      ...
      Group(
        ...
        items: [
          ...
          VariableSelection(
            name: 'finnegan-tremors',
            display: t('tremors.display'),
            description: t('tremors.description'),
            type: VariableType.select,
            options: [
              VariableOption(display: t('tremors.0'), value: 0),
              VariableOption(display: t('tremors.1'), value: 1),
              VariableOption(display: t('tremors.2'), value: 2),
              VariableOption(display: t('tremors.3'), value: 3),
              VariableOption(display: t('tremors.4'), value: 4),
            ],
          ),
          VariableBool(
